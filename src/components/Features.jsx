...
return (
<div className="lightbox-overlay" onClick={handleOverlayClick} onMouseEnter={(e) => e.stopPropagation()} onMouseLeave={(e) => e.stopPropagation()}>
...
const VideoCard = ({ video, onClick, isFiltered, shouldShow }) => {
...
if (cardRef.current) {
if (isFiltered) {
cardRef.current.style.opacity = shouldShow ? '1' : '0.3';
} else {
...
{ id: 2, title: "Motion Graphics", category: "Video editing", thumbnail: "/api/placeholder/400/300", video: "/api/placeholder/400/300", },
{ id: 3, title: "Product Animation", category: "Animation", thumbnail: "/api/placeholder/400/300", video: "/api/placeholder/400/300", },
{ id: 4, title: "3D Animation", category: "Animation", thumbnail: "/api/placeholder/400/300", video: "/api/placeholder/400/300", },
{ id: 5, title: "Logo Reveal", category: "Video editing", thumbnail: "/api/placeholder/400/300", video: "/api/placeholder/400/300", },
{ id: 6, title: "Brand Animation", category: "Animation", thumbnail: "/api/placeholder/400/300", video: "/api/placeholder/400/300", },
{ id: 7, title: "Motion Graphics", category: "Video editing", thumbnail: "/api/placeholder/400/300", video: "/api/placeholder/400/300", },
{ id: 8, title: "Product Animation", category: "Animation", thumbnail: "/api/placeholder/400/300", video: "/api/placeholder/400/300", },
{ id: 9, title: "3D Animation", category: "Animation", thumbnail: "/api/placeholder/400/300", video: "/api/placeholder/400/300", },
{ id: 10, title: "Logo Reveal", category: "Animation", thumbnail: "/api/placeholder/400/300", video: "/api/placeholder/400/300", },
];
...
if (!isFiltered) setIsPaused(false); 
};
...
if (!selectedVideo && !isFiltered) { 
setIsPaused(false); 
} 
}, 500);
};

const handleShowcaseMouseEnter = (e) => { 
if (!selectedVideo && e.target === showcaseRef.current && !isFiltered) { 
setIsPaused(true); 
} 
};

const handleShowcaseMouseLeave = (e) => { 
if (!selectedVideo && !showcaseRef.current?.contains(e.relatedTarget) && !isFiltered) { 
setIsPaused(false); 
} 
};
...
if (!slider || isFiltered) return;
const handleAnimationIteration = () => { slider.scrollLeft = 0; };
...
onClick={handleVideoClick} 
isFiltered={isFiltered} 
shouldShow={activeFilter === 'All' || video.category === activeFilter} 
/> 
))}
</div>
</div>
